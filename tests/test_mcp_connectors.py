...
class MCPConnectorTests(unittest.TestCase):
    def setUp(self):
        ...
        os.environ["LUTHOR_MCP_WHISPER_ENABLED"] = "false"
        os.environ["LUTHOR_MCP_YTDLP_ENABLED"] = "false"
        os.environ["LUTHOR_MCP_FOOOCUS_ENABLED"] = "false"
        os.environ["LUTHOR_MCP_CALCOM_ENABLED"] = "false"
